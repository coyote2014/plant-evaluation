 ...
 *
 * 	FileWizardPage.java is part of Plant Evaluation.
 *
...
public class FileSelectionWizardPage extends AbstractWizardPage {

	protected PlotWizard plotWizard;

	protected File dataFile;
	protected JButton selectInputFileButton;
	protected JTextField fileNameTextField;
	protected JSpinner widthSpinner, heightSpinner;

	public FileSelectionWizardPage(PlotWizard parent) {
	 ...
	 * @param parent
	 */
	public FileSelectionWizardPage(String title, String description, PlotWizard parent) {
